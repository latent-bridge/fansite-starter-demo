...
export const STREAMER: Streamer = {
  ...
  tagline: "ファンサイトテンプレートのデモ配信者プロフィール。",
  bio: "ここに配信者の自己紹介。MIDNIGHT OPS デザインのスターターテンプレートで、各配信者向けにコピーして使うことを想定しています。",
  stats: {
    followers: "12,345",
    subs: "678",
    streams: "100",
  ...
  games: ["DEMO GAME A", "DEMO GAME B", "雑談"],
  socials: [
    { k: "yt", label: "YouTube", url: "#" },
    { k: "x", label: "X / Twitter", url: "#" },
